...
import { IK_SCALES, CURRENT_IK_SCALE_YEAR, IK_BRACKETS } from './scales.js';
...
export function getIkScale(year = CURRENT_IK_SCALE_YEAR) {
  return IK_SCALES[year] || IK_SCALES[CURRENT_IK_SCALE_YEAR];
}

/** Coefficients applicables a un vehicule donne. */
export function getIkCoefficients(vehicle, year = CURRENT_IK_SCALE_YEAR) {
 ...
 */
export function annualIkAmount(km, vehicle, year = CURRENT_IK_SCALE_YEAR) {
