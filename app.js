...
function exportBackup(){ downloadBlob(JSON.stringify(state,null,2),'application/json',`agilmea-ik-sauvegarde-${new Date().toISOString().slice(0,10)}.json`); }
